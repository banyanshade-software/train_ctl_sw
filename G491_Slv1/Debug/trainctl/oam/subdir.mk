...
clean-trainctl-2f-oam:
	-$(RM) ./trainctl/oam/boards.cyclo ./trainctl/oam/boards.d ./trainctl/oam/boards.o ./trainctl/oam/boards.su ./trainctl/oam/oam.cyclo ./trainctl/oam/oam.d ./trainctl/oam/oam.o ./trainctl/oam/oam.su ./trainctl/oam/oam_detect.cyclo ./trainctl/oam/oam_detect.d ./trainctl/oam/oam_detect.o ./trainctl/oam/oam_detect.su ./trainctl/oam/oam_error.cyclo ./trainctl/oam/oam_error.d ./trainctl/oam/oam_error.o ./trainctl/oam/oam_error.su
