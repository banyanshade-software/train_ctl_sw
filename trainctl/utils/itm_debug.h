...
#define DBG_POSEADJ (1UL<<15)
#define DBG_TRKPLN	(1UL<<16)
#define DBG_USB		(1UL<<17)
#define DBG_LED     (1UL<<18)
#define DBG_AUTO    (1UL<<19)
#define DBG_DETECT  (1UL<<20)
#define DBG_CAN     (1UL<<21)
#define DBG_OAM     (1UL<<22)
#define DBG_SERVO   (1UL<<23)
#define DBG_BRAKE   (1UL<<24)
