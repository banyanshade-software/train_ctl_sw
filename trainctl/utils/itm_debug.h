...
#define DBG_UI		(1UL<<12)
#define DBG_ADC 	(1UL<<13)
#define DBG_POSE	(1UL<<14)
#define DBG_POSEC   (1UL<<15)
#define DBG_POSEADJ (1UL<<16)
#define DBG_TRKPLN	(1UL<<17)
#define DBG_USB		(1UL<<18)
#define DBG_LED     (1UL<<19)
#define DBG_AUTO    (1UL<<20)
#define DBG_DETECT  (1UL<<21)
#define DBG_CAN     (1UL<<22)
#define DBG_OAM     (1UL<<23)
#define DBG_SERVO   (1UL<<24)
#define DBG_BRAKE   (1UL<<25)
