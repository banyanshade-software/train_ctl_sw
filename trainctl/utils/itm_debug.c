...
/* debug flags */
 uint32_t debug_flags = DBG_ERR | DBG_TURNOUT; // DBG_PRES | DBG_CTRL | DBG_CTRLHI | DBG_POSEC ;//| DBG_ADC ;//| DBG_POSE; // DBG_POSE;// |DBG_SPDCTL|DBG_PID| DBG_PRES|DBG_CTRL; //| DBG_PRES | DBG_INA3221;// | DBG_INA3221 | DBG_PRES | DBG_UI; //| DBG_ADC; //| DBG_CTRL | DBG_SPDCTL|DBG_PID;//| DBG_UI;// |DBG_MSG;
 // | DBG_PRES | DBG_SPDCT
