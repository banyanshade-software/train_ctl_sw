...
/* debug flags */
uint32_t debug_flags = DBG_ERR  | DBG_CTRL|DBG_DETECT; //|DBG_TIM; //|DBG_INA3221| DBG_CTRL; //DBG_DETECT | DBG_AUTO | DBG_CTRL | DBG_POSEC;// | DBG_ADC ; //| DBG_INERTIA | DBG_SPDCTL | DBG_CTRL;// |DBG_CTRL | DBG_INA3221 ;//| DBG_ADC | DBG_INA3221 | DBG_LOWCTRL;
