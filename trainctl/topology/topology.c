...
static const topo_lsblk_t _Topology[] = {
    ...
    /* 0 */ { MA_CANTON(0, 0),  0xFF,   84,    -1,   -1, 0xFF,       1,  -1,    0       _PTS({5,8}, {5,4}, {4,3}, {1,3})},
    /* 1 */ { MA_CANTON(0, 1),  0xFF,   42,     0,    2,    0,      -1,   3,    1       _PTS({5,9}, {5,12}, _VP, _VP)},
    /* 2 */ { MA_CANTON(0, 2),  0xFF,   73,    -1 ,  -1, 0xFF,      -1,   1,    0       _PTS({4,8}, {4,5}, {3,4}, {1,4})},
    /* 3 */ { MA_CANTON(0, 3),  0xFF,   32, 	4,    1,    1,      -1,  -1, 0xFF       _PTS({6,13}, {6,15}, {5,16}, {1,16})},
    /* 4 */ { MA_CANTON(0, 3),  0xFF,   105,   -1 ,  -1, 0xFF,       3,  -1,    1       _PTS({6,12}, {6,3}, {5,2}, {1,2})}
};
