...
#else
    /* 4 */ { MA_CANTON(0, 3),  0xFF,    90,   5 ,  -1,     2,       3,  -1,    1       _PTS(0, {7,4}, {7,8}, {6,10}, {6,12})},
    /* 5 */ { MA_CANTON(0, 3),  0xFF,    50,   -1,  -1,  0xFF,       4,   6,    2       _PTS(0, {1,2}, {6,2}, {7,3}, _VP)},
    /* 6 */ { MA_CANTON(0, 3),  0xFF,    20,   -1,   4,     2,       -1, -1, 0xFF       _PTS(0, {6,4}, {6,6}, _VP, _VP)}
#endif
};
